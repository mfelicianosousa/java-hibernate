...
public class hql_query_between {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Query query = sessao.createQuery("from Aluno where id = 2");      
            // Query query = sessao.createQuery("from Aluno where id >= 2");      
            // Query query = sessao.createQuery("from Aluno where id between 2 and 3");      
            Query query = sessao.createQuery("from Aluno where id between :codini and :codfinal");
            query.setInteger("codini", 2);
            query.setInteger("codfinal", 3);
